...
struct ServerContext; // forward declaration so that clients don't freak out over this
...
public:
    ...
    virtual void execute(ServerContext &ctx, int client_fd) = 0; // processes a received command
